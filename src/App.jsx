  ...
  return (
    <>
      ...
      <div className="container mt-5">
        ...
        >
          I enjoy reading and doing <span className="marker-highlight" onClick={() => setProjectsVisible(true)}>projects</span> on my free time.
        </DraggableWindow>
      </div>
        ...
        <div className="container mt-5">
          ...
          >
            <div className="project-list">
              <a href="https://github.com/znrfrnz/CheckMate" target="_blank" rel="noopener noreferrer" className="project-item">
              ...
              <a href="https://github.com/znrfrnz/oakmont" target="_blank" rel="noopener noreferrer" className="project-item">
              ...
              <a href="https://plm-hackathon.web.app" target="_blank" rel="noopener noreferrer" className="project-item">
